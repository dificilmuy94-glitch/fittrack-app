...
export const WEEKLY_PLAN: DayPlan[] = [
  ...
  // ─── MARTES — PIERNA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'tue-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/12/barbell-bulgarian-split-squat-resized.png', name: 'Sentadilla Búlgara (A2)', muscleGroup: 'Cuádriceps / Glúteo',
      ...
      { id: 'tue-5', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/hack-squat-resized.png', name: 'Hack Squat Machine', muscleGroup: 'Cuádriceps',
  ...
  // ─── MIÉRCOLES — HOMBROS ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'wed-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/barbell-shoulder-press-resized.png', name: 'Delts - Barbell Shoulder Press', muscleGroup: 'Deltoides',
      ...
      { id: 'wed-3', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/smith-machine-shoulder-press-resized.png', name: 'Delts - Shoulder Press Smith Machine', muscleGroup: 'Deltoides',
      ...
      { id: 'wed-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/06/cable-rear-delt-fly-resized.png', name: 'Reverse Cable Fly for Delts', muscleGroup: 'Deltoides Posterior',
        youtubeId: 'QL_xSZFGEoc', primaryMuscles: [M.rear_delts], secondaryMuscles: [M.traps],
        targetSets: 4, targetReps: 12, restSeconds: 120, tempo: '2-1-1-0',
        description: '4 series × 12 · 120" descanso · Tempo 2110.' },
      { id: 'wed-5', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/front-raise-resized.png', name: 'Delts - Barbell Front Raise (G1)', muscleGroup: 'Deltoides Anterior',
  ...
  // ─── JUEVES — PIERNA (GLÚTEO / ISQUIOS) ──────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'thu-6', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/hip-abduction-machine-resized.png', name: 'Abductor en Máquina', muscleGroup: 'Abductores / Glúteo',
  ...
  // ─── VIERNES — BÍCEPS / TRÍCEPS ──────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'fri-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/close-grip-bench-press-resized.png', name: 'Triceps - Close Grip Bench Press (A1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/spider-curl-resized.png', name: 'Biceps - Db Spider Curl (B2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-7', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/neutral-grip-lat-pulldown-resized.png', name: 'Neutral Grip Lat Pull Down', muscleGroup: 'Dorsal / Bíceps',
      ...
      { id: 'fri-8', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/push-up-resized.png', name: 'Triceps Push Up', muscleGroup: 'Tríceps',
  ...
  // ─── SÁBADO — PECHO ──────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'sat-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/cable-crossover-resized.png', name: 'Chest - High Cable Flys', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-3', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/decline-dumbbell-bench-press-resized.png', name: 'Press Declinado Mancuernas (C1)', muscleGroup: 'Pectoral Inferior',
      ...
      { id: 'sat-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/decline-crunch-resized.png', name: 'Decline Crunch (C2)', muscleGroup: 'Abdomen',
      ...
      { id: 'sat-6', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/push-up-resized.png', name: 'Delts - Push Up (D2)', muscleGroup: 'Pectoral / Tríceps',
