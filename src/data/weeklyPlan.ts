...
export const WEEKLY_PLAN: DayPlan[] = [
  // ─── LUNES — ESPALDA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'mon-1', name: 'Back - Seated Cable Row', muscleGroup: 'Dorsal / Romboides',
      ...
      { id: 'mon-2', name: 'Back - Lean Away Lat Pull Down', muscleGroup: 'Dorsal',
      ...
      { id: 'mon-3', name: 'Back - Single Arm Dumbbell Row', muscleGroup: 'Dorsal / Bíceps',
      ...
      { id: 'mon-4', name: 'Delts - Cable Rear Delt Flys', muscleGroup: 'Deltoides Posterior',
      ...
      { id: 'mon-5', name: 'Machine Row', muscleGroup: 'Espalda Media',
  ...
  // ─── MARTES — PIERNA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'tue-1', name: 'Quads - Leg Press (A1)', muscleGroup: 'Cuádriceps',
      ...
      { id: 'tue-2', name: 'Sentadilla Búlgara (A2)', muscleGroup: 'Cuádriceps / Glúteo',
      ...
      { id: 'tue-3', name: 'Hamstring - Romanian Deadlift (B1)', muscleGroup: 'Isquiotibiales / Glúteo',
      ...
      { id: 'tue-4', name: 'Quads - Bar Walking Lunge (B2)', muscleGroup: 'Cuádriceps / Glúteo',
      ...
      { id: 'tue-5', name: 'Hack Squat Machine', muscleGroup: 'Cuádriceps',
      ...
      { id: 'tue-6', name: 'Quads - Single Leg Extension', muscleGroup: 'Cuádriceps',
        youtubeId: 'YyvSfVjQeL0', primaryMuscles: [M.quads], secondaryMuscles: [],
        targetSets: 4, targetReps: 12, restSeconds: 120, tempo: '2-1-1-0',
        description: '4 series × 12-12-10-10 · 120" descanso · Tempo 2110.' },
      { id: 'tue-7', name: 'Hamstrings - Seated Leg Curl', muscleGroup: 'Isquiotibiales',
  ...
  // ─── MIÉRCOLES — HOMBROS ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'wed-1', name: 'Delts - Barbell Shoulder Press', muscleGroup: 'Deltoides',
      ...
      { id: 'wed-2', name: 'Back - Seated Cable Rows (Pronación)', muscleGroup: 'Dorsal / Romboides',
      ...
      { id: 'wed-3', name: 'Delts - Shoulder Press Smith Machine', muscleGroup: 'Deltoides',
      ...
      { id: 'wed-4', name: 'Reverse Cable Fly for Delts', muscleGroup: 'Deltoides Posterior',
        youtubeId: 'QL_xSZFGEoc', primaryMuscles: [M.rear_delts], secondaryMuscles: [M.traps],
        targetSets: 4, targetReps: 12, restSeconds: 120, tempo: '2-1-1-0',
        description: '4 series × 12 · 120" descanso · Tempo 2110.' },
      { id: 'wed-5', name: 'Delts - Barbell Front Raise (G1)', muscleGroup: 'Deltoides Anterior',
      ...
      { id: 'wed-6', name: 'Delts - DB Y Raise (G2)', muscleGroup: 'Deltoides / Trapecio',
      ...
      { id: 'wed-7', name: 'Delts - Seated DB Lateral Raise (G3)', muscleGroup: 'Deltoides Lateral',
  ...
  // ─── JUEVES — PIERNA (GLÚTEO / ISQUIOS) ──────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'thu-1', name: 'Quads - Leg Press', muscleGroup: 'Cuádriceps',
        youtubeId: 'IZxyjW7MPJQ', primaryMuscles: [M.quads], secondaryMuscles: [M.glutes],
      ...
      { id: 'thu-2', name: 'Hamstring - Romanian Deadlift (Banded)', muscleGroup: 'Isquiotibiales / Glúteo',
        youtubeId: 'JCXUYuzwNrM', primaryMuscles: [M.hamstrings, M.glutes], secondaryMuscles: [],
      ...
      { id: 'thu-3', name: 'Hip Thrust en Banco', muscleGroup: 'Glúteo',
      ...
      { id: 'thu-4', name: 'Hamstring - Single-Leg Hamstring Curl', muscleGroup: 'Isquiotibiales',
      ...
      { id: 'thu-5', name: 'Buenos días con barra (Good Morning)', muscleGroup: 'Isquiotibiales / Lumbar',
      ...
      { id: 'thu-6', name: 'Abductor en Máquina', muscleGroup: 'Abductores / Glúteo',
  ...
  // ─── VIERNES — BÍCEPS / TRÍCEPS ──────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'fri-1', name: 'Triceps - Close Grip Bench Press (A1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-2', name: 'Curl Barra Z (A2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-3', name: 'Overhead Rope Triceps Extension (B1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-4', name: 'Biceps - Db Spider Curl (B2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-5', name: 'Standing Rope Triceps Extension (C1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-6', name: 'Biceps - Incline Dumbbell Curl (C2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-7', name: 'Neutral Grip Lat Pull Down', muscleGroup: 'Dorsal / Bíceps',
      ...
      { id: 'fri-8', name: 'Triceps Push Up', muscleGroup: 'Tríceps',
  ...
  // ─── SÁBADO — PECHO ──────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'sat-1', name: 'Chest - High Cable Flys', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-2', name: 'Chest - Dumbbell Bench Press', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-3', name: 'Press Declinado Mancuernas (C1)', muscleGroup: 'Pectoral Inferior',
      ...
      { id: 'sat-4', name: 'Decline Crunch (C2)', muscleGroup: 'Abdomen',
      ...
      { id: 'sat-5', name: 'Chest - Peck Deck Flyes (D1)', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-6', name: 'Delts - Push Up (D2)', muscleGroup: 'Pectoral / Tríceps',
      ...
      { id: 'sat-7', name: 'Standing Rope Triceps Extension (E1)', muscleGroup: 'Tríceps',
        youtubeId: 'kiuVA0gs3EI', primaryMuscles: [M.triceps], secondaryMuscles: [],
        targetSets: 3, targetReps: 13, restSeconds: 0, tempo: '2-0-2-1',
        description: 'SUPERSERIE E · 3 rondas × 12-15 · Sin descanso · Tempo 2021.' },
      { id: 'sat-8', name: 'Overhead Rope Triceps Extension (E2)', muscleGroup: 'Tríceps',
        youtubeId: 'vB5OHsJ3EME', primaryMuscles: [M.triceps], secondaryMuscles: [],
