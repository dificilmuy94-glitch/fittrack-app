...
export const WEEKLY_PLAN: DayPlan[] = [
  // ─── LUNES — ESPALDA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'mon-5', imageUrl: 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cable_Seated_Row/0.jpg', name: 'Machine Row', muscleGroup: 'Espalda Media',
  ...
  // ─── JUEVES — PIERNA (GLÚTEO / ISQUIOS) ──────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'thu-6', imageUrl: 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hip_Abductor/0.jpg', name: 'Abductor en Máquina', muscleGroup: 'Abductores / Glúteo',
