...
export const WEEKLY_PLAN: DayPlan[] = [
  ...
  // ─── MARTES — PIERNA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'tue-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/12/dumbbell-bulgarian-split-squat-resized.png', name: 'Sentadilla Búlgara (A2)', muscleGroup: 'Cuádriceps / Glúteo',
  ...
  // ─── VIERNES — BÍCEPS / TRÍCEPS ──────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'fri-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/incline-dumbbell-curl-resized.png', name: 'Biceps - Db Spider Curl (B2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-7', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/lat-pulldown-resized.png', name: 'Neutral Grip Lat Pull Down', muscleGroup: 'Dorsal / Bíceps',
  ...
  // ─── SÁBADO — PECHO ──────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'sat-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/cable-fly-resized.png', name: 'Chest - High Cable Flys', muscleGroup: 'Pectoral',
