...
export const WEEKLY_PLAN: DayPlan[] = [
  // ─── LUNES — ESPALDA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'mon-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2023/09/Straight-back-seated-cable-row-with-straight-bar-768x512.png', name: 'Back - Seated Cable Row', muscleGroup: 'Dorsal / Romboides',
      ...
      { id: 'mon-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/lat-pulldown-resized.png', name: 'Back - Lean Away Lat Pull Down', muscleGroup: 'Dorsal',
      ...
      { id: 'mon-3', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/one-arm-dumbbell-row-resized.png', name: 'Back - Single Arm Dumbbell Row', muscleGroup: 'Dorsal / Bíceps',
      ...
      { id: 'mon-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/06/cable-rear-delt-fly-resized.png', name: 'Delts - Cable Rear Delt Flys', muscleGroup: 'Deltoides Posterior',
      ...
      { id: 'mon-5', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/seated-cable-row-resized.png', name: 'Machine Row', muscleGroup: 'Espalda Media',
  ...
  // ─── MARTES — PIERNA ─────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'tue-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/leg-press-resized.png', name: 'Quads - Leg Press (A1)', muscleGroup: 'Cuádriceps',
      ...
      { id: 'tue-2', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2023/07/barbell-bulgarian-split-squat.png', name: 'Sentadilla Búlgara (A2)', muscleGroup: 'Cuádriceps / Glúteo',
      ...
      { id: 'tue-3', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/romanian-deadlift-resized.png', name: 'Hamstring - Romanian Deadlift (B1)', muscleGroup: 'Isquiotibiales / Glúteo',
      ...
      { id: 'tue-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/barbell-walking-lunge-resized.png', name: 'Quads - Bar Walking Lunge (B2)', muscleGroup: 'Cuádriceps / Glúteo',
      ...
      { id: 'tue-5', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/10/hack-squat-muscles-worked.png', name: 'Hack Squat Machine', muscleGroup: 'Cuádriceps',
      ...
      { id: 'tue-6', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/leg-extension-resized.png', name: 'Quads - Single Leg Extension', muscleGroup: 'Cuádriceps',
        youtubeId: 'YyvSfVjQeL0', primaryMuscles: [M.quads], secondaryMuscles: [],
        targetSets: 4, targetReps: 12, restSeconds: 120, tempo: '2-1-1-0',
        description: '4 series × 12-12-10-10 · 120" descanso · Tempo 2110.' },
      { id: 'tue-7', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/seated-leg-curl-resized.png', name: 'Hamstrings - Seated Leg Curl', muscleGroup: 'Isquiotibiales',
  ...
  // ─── MIÉRCOLES — HOMBROS ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'wed-1', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/barbell-overhead-press-muscles-worked.png', name: 'Delts - Barbell Shoulder Press', muscleGroup: 'Deltoides',
      ...
      { id: 'wed-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2023/09/Straight-back-seated-cable-row-with-straight-bar-768x512.png', name: 'Back - Seated Cable Rows (Pronación)', muscleGroup: 'Dorsal / Romboides',
      ...
      { id: 'wed-3', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/barbell-overhead-press-muscles-worked.png', name: 'Delts - Shoulder Press Smith Machine', muscleGroup: 'Deltoides',
      ...
      { id: 'wed-4', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2023/07/cable-rear-delt-fly-muscles-worked.png', name: 'Reverse Cable Fly for Delts', muscleGroup: 'Deltoides Posterior',
        youtubeId: 'QL_xSZFGEoc', primaryMuscles: [M.rear_delts], secondaryMuscles: [M.traps],
        targetSets: 4, targetReps: 12, restSeconds: 120, tempo: '2-1-1-0',
        description: '4 series × 12 · 120" descanso · Tempo 2110.' },
      { id: 'wed-5', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/front-raise-muscles-worked.png', name: 'Delts - Barbell Front Raise (G1)', muscleGroup: 'Deltoides Anterior',
      ...
      { id: 'wed-6', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/dumbbell-lateral-raise-resized.png', name: 'Delts - DB Y Raise (G2)', muscleGroup: 'Deltoides / Trapecio',
      ...
      { id: 'wed-7', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/dumbbell-lateral-raise-resized.png', name: 'Delts - Seated DB Lateral Raise (G3)', muscleGroup: 'Deltoides Lateral',
  ...
  // ─── JUEVES — PIERNA (GLÚTEO / ISQUIOS) ──────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'thu-1', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/leg-press-resized.png', name: 'Quads - Leg Press', muscleGroup: 'Cuádriceps',
        youtubeId: 'IZxyjW7MPJQ', primaryMuscles: [M.quads], secondaryMuscles: [M.glutes],
      ...
      { id: 'thu-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/romanian-deadlift-resized.png', name: 'Hamstring - Romanian Deadlift (Banded)', muscleGroup: 'Isquiotibiales / Glúteo',
        youtubeId: 'JCXUYuzwNrM', primaryMuscles: [M.hamstrings, M.glutes], secondaryMuscles: [],
      ...
      { id: 'thu-3', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2017/04/barbell-hip-thrust-resized.png', name: 'Hip Thrust en Banco', muscleGroup: 'Glúteo',
      ...
      { id: 'thu-4', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/12/kneeling-leg-curl-resized.png', name: 'Hamstring - Single-Leg Hamstring Curl', muscleGroup: 'Isquiotibiales',
      ...
      { id: 'thu-5', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/good-morning-resized.png', name: 'Buenos días con barra (Good Morning)', muscleGroup: 'Isquiotibiales / Lumbar',
      ...
      { id: 'thu-6', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/11/hip-abduction-machine-muscles-worked.png', name: 'Abductor en Máquina', muscleGroup: 'Abductores / Glúteo',
  ...
  // ─── VIERNES — BÍCEPS / TRÍCEPS ──────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'fri-1', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/close-grip-bench-press-muscles-worked.png', name: 'Triceps - Close Grip Bench Press (A1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/ez-bar-curl-resized.png', name: 'Curl Barra Z (A2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-3', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/overhead-triceps-extension-resized.png', name: 'Overhead Rope Triceps Extension (B1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-4', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/spider-curl-muscles-worked.png', name: 'Biceps - Db Spider Curl (B2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-5', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/triceps-pushdown-resized.png', name: 'Standing Rope Triceps Extension (C1)', muscleGroup: 'Tríceps',
      ...
      { id: 'fri-6', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/incline-dumbbell-curl-resized.png', name: 'Biceps - Incline Dumbbell Curl (C2)', muscleGroup: 'Bíceps',
      ...
      { id: 'fri-7', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2023/11/neutral-grip-lat-pulldown-benefits.png', name: 'Neutral Grip Lat Pull Down', muscleGroup: 'Dorsal / Bíceps',
      ...
      { id: 'fri-8', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/push-up-muscles-worked.png', name: 'Triceps Push Up', muscleGroup: 'Tríceps',
  ...
  // ─── SÁBADO — PECHO ──────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: 'sat-1', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/11/cable-crossover-muscles-worked.png', name: 'Chest - High Cable Flys', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-2', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/dumbbell-bench-press-resized.png', name: 'Chest - Dumbbell Bench Press', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-3', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/decline-dumbbell-bench-press-muscles-worked.png', name: 'Press Declinado Mancuernas (C1)', muscleGroup: 'Pectoral Inferior',
      ...
      { id: 'sat-4', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/decline-crunch-muscles-worked.png', name: 'Decline Crunch (C2)', muscleGroup: 'Abdomen',
      ...
      { id: 'sat-5', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/pec-deck-fly-resized.png', name: 'Chest - Peck Deck Flyes (D1)', muscleGroup: 'Pectoral',
      ...
      { id: 'sat-6', imageUrl: 'https://www.inspireusafoundation.org/wp-content/uploads/2022/09/push-up-muscles-worked.png', name: 'Delts - Push Up (D2)', muscleGroup: 'Pectoral / Tríceps',
      ...
      { id: 'sat-7', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/triceps-pushdown-resized.png', name: 'Standing Rope Triceps Extension (E1)', muscleGroup: 'Tríceps',
        youtubeId: 'kiuVA0gs3EI', primaryMuscles: [M.triceps], secondaryMuscles: [],
        targetSets: 3, targetReps: 13, restSeconds: 0, tempo: '2-0-2-1',
        description: 'SUPERSERIE E · 3 rondas × 12-15 · Sin descanso · Tempo 2021.' },
      { id: 'sat-8', imageUrl: 'https://weighttraining.guide/wp-content/uploads/2016/05/overhead-triceps-extension-resized.png', name: 'Overhead Rope Triceps Extension (E2)', muscleGroup: 'Tríceps',
        youtubeId: 'vB5OHsJ3EME', primaryMuscles: [M.triceps], secondaryMuscles: [],
